        ...
        <div className="page-wrapper">
            <div className="section black-gradient wf-section">
                <div className="container">
                    ...
                    <h1>AstroTwin</h1>
                    <p className="paragraph medium">Find your celebrity astrology twin! Entering your birth information so your chart can be calculated and compared with over 200 celebrity birth charts to find your best match!</p>
